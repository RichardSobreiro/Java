package example.richard.easymotoboy;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "foo@example.com:123456rr", "bar@example.com:world"
    };
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mRegisterMotoBoy = (Button) findViewById(R.id.register_motoboy);
        mRegisterMotoBoy.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LoginActivity.this,RegisterMotoBoy.class);
                startActivity(intent);
            }
        });
